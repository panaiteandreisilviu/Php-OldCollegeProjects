...
<div class="banner-bg" id="home">
    <div class="container">
        <div class="header">
            <div class="logo">
                <a href="index.php"><h1>Fashion</h1><span>Change Your Hair Style</span></a>
            </div>
            ...
            <div class="top-nav">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown1"><a href="#">Features</a>
                        <ul class="dropdown2">
                            <li><a href="404.html">Events</a></li>
                            <li><a href="typography.html">Shortcode</a></li>
                    ...
                    <li id="loginLI"><a href="#" id="loginHover">Login</a>

                        <div id="loginContainer">
                            <form action="php/login.php" id="loginForm" method="POST">
                                <input type="text" class="form-control marginTop" name='username' placeholder="username"
                                       id="usernameInput">
                                <input type="password" class="form-control marginTop" name='password'
                                       placeholder="password"
                                       id="passwordInput">

                                <div class="form-group"><label for="isAngajat">Im an employee
                                        <input type="checkbox" name="isAngajat" id="isAngajat">
                                </div>
            ...
            <ul class="rslides" id="slider4">
                <li>
                    <div class="banner-info">
                        ...
                        <lable></lable>
                        <p>Lorem Ipsum Maecenas tristique orci ac sem. Duis ultricies pharetra magna. Donec accumsan
                            malesuada orci. Donec sit amet eros. Lorem ipsumipsum dolor sit amet, consectetuer dolor
                            sit.</p>
                    </div>
                </li>
                <li>
        ...
        <div class="banner-bottom-info">
            <div class="col-md-3 b-grids">
                ...
                <div class="album-box">
                    ...
                    <p>We are glad to welcome you in our store.We are glad to welcome you in our store.choosing our
                        store.</p>
                </div>
            </div>
            <div class="col-md-3 b-grids">
...
<div class="about">
    <div class="container">
        ...
        <p>Donec orci arcu, convallis id massa ac, imperdiet aliquet massa. Vivamus sit amet felis vitae nibh porttitor
            faucibus a eget risus. Aliquam bibendum quam leo, id vehicula enim elementum et. Aenean id turpis mattis,
            sagittis urna vehicula, euismod risus. Praesent mattis est et vulputate accumsan.Proin luctus, justo sit
            amet laoreet venenatis, libero velit tincidunt mi, nec fermentum ante massa id quam. In gravida erat vel
            diam blandit consequat. Morbi ut interdum nunc, eu egestas arcu.</p>
    ...
    <div class="container">
        ...
        <div class="grid">
            <div class="col-md-4 h-f">
                ...
                <div class="hf-text"><h5>Long Silky</h5>
            ...
            <div class="col-md-4 h-f">
                ...
                <div class="hf-text"><h5>Fishtail</h5>
            ...
            <div class="col-md-4 h-f">
                ...
                <div class="hf-text"><h5>French Twisted</h5>
            ...
            <div class="col-md-6 col-news-right">
                <div class="col-bottom">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                        ...
                        tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem </p>
    ...
    <div class="container">
        <div class="footer-grids wow bounceIn animated" data-wow-delay="0.4s">
            <div class="col-md-3 footer-grid">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id arcu neque, at convallis est
                    felis.</p>

                <p class="sub">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id arcu neque, at
                    convallis est felis.</p>
            </div>
